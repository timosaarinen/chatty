...
This specification defines the authoritative protocol requirements, based on the TypeScript schema in [schema.ts](./schema.ts) (original link: https://github.com/modelcontextprotocol/specification/blob/main/schema/2025-03-26/schema.ts).
...
[Client Feature: Roots](./client/roots.md)
[Client Feature: Sampling](./client/sampling.md)